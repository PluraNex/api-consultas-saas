package com.pluranex.api_consulta_saas.infrastructure.procedimento.mapper
...
import com.pluranex.api_consulta_saas.infrastructure.shared.mapper.BaseMapper

object ProcedimentoMapper : BaseMapper<Procedimento, ProcedimentoModel> {

    override fun toDomain(model: ProcedimentoModel): Procedimento =
        Procedimento(
            id = model.id,
    ...
    override fun toModel(domain: Procedimento): ProcedimentoModel =
        ProcedimentoModel(
            id = domain.id,
